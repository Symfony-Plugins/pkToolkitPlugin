...
/**
 * pkWidgetFormStaticText presents static text in a widget. This should always be paired with an sfValidatorPass validator.
 *
 ...
 * if ($housingDetails)
 * {
 *   $this->setWidget('housing_details', new pkWidgetFormStaticText($housingDetails));
 ...
 *
 */
class pkWidgetFormStaticText extends sfWidgetFormInput
{
  protected $label;
