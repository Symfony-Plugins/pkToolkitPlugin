...
{
	pkCheckboxEnablesBody(boxSelector, itemsSelector, hideItemsSelector, true);
}

function pkCheckboxDisables(boxSelector, itemsSelector, hideItemsSelector)
{
	pkCheckboxEnablesBody(boxSelector, itemsSelector, hideItemsSelector, false);
}

function pkCheckboxEnablesBody(boxSelector, itemsSelector, hideItemsSelector, enable)
{
